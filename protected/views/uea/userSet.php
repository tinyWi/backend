            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post" action="<?php echo yii::app()->createUrl('Uea/UserSet');?>">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="radio" value="<?php echo Consts::USER_STATUS_ONLINE;?>" <?php echo Consts::USER_STATUS_ONLINE == $userRow['status']? 'checked="checked"': '';?> name="status"> 正常
									<input type="radio" value="<?php echo Consts::USER_STATUS_PAUSE;?>" <?php echo Consts::USER_STATUS_PAUSE == $userRow['status']? 'checked="checked"': '';?> name="status"> 待审核
                                </div>
                            </div>
                            <div class="form-group">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select name="role">
										...
										<option value="<?php echo $role['name'];?>" <?php echo $userRow['roleRow']['name'] == $role['name']? 'selected="selected"': '';?>><?php echo $role['desc'];?></option>
										<?php endforeach;?>
									</select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-3">
									...
									<input type="hidden" name="oldRole" value="<?php echo $oldRole;?>"/>
